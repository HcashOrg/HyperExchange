...
namespace graphene {
	namespace crosschain {
		...
		fc::variant_object crosschain_interface_ltc::create_multisig_transaction(const std::string &from_account, const std::map<std::string,std::string> dest_info, const std::string &symbol, const std::string &memo,const std::string& prk)
		{
			std::ostringstream req_body;
			req_body << "{ \"jsonrpc\": \"2.0\", \
                \"id\" : \"45\", \
		...
		std::string crosschain_interface_ltc::sign_multisig_transaction(fc::variant_object trx, const std::string &sign_account,const std::string& redeemScript,bool broadcast /*= true*/)
		{
