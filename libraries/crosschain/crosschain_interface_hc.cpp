...
namespace graphene {
	namespace crosschain {
		...
		std::string crosschain_interface_hc::create_normal_account(std::string account_name)
		{
		...
		std::string crosschain_interface_hc::create_sub_account(std::string account_name, const fc::ecc::private_key &p)
		{
			auto ptr = graphene::privatekey_management::crosschain_management::get_instance().get_crosschain_prk(chain_type);
			if (ptr == nullptr)
				return "";
