...
namespace graphene {
	namespace crosschain {
		...
		class crosschain_interface_bch : public abstract_crosschain_interface
		{
		public:
			crosschain_interface_bch() {}
			virtual ~crosschain_interface_bch() {}
		...
		private:
			...
			std::string _rpc_url;
			const std::string chain_type = std::string("BCH");
