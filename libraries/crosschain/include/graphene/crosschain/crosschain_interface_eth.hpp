...
namespace graphene {
	namespace crosschain {
		...
		class crosschain_interface_eth : public abstract_crosschain_interface
		{
		public:
			crosschain_interface_eth() {}
			crosschain_interface_eth(std::string chain_id):chain_type(chain_id){}
			virtual ~crosschain_interface_eth() {}
		...
		private:
			...
			std::string _rpc_url;
			const std::string chain_type = std::string("ETH");
