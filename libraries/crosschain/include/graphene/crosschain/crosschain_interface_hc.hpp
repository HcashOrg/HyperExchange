...
namespace graphene {
	namespace crosschain {
		...
		class crosschain_interface_hc : public abstract_crosschain_interface
		{
		public:
			crosschain_interface_hc() {}
			virtual ~crosschain_interface_hc() {}
			...
			virtual bool validate_link_trx_v1(const hd_trx &trx) override;
