...
namespace graphene {
	namespace crosschain {
		...
		class crosschain_interface_btm : public abstract_crosschain_interface
		{
		public:
			crosschain_interface_btm() {}
			virtual ~crosschain_interface_btm() {}
		...
		private:
			...
			std::string _rpc_url;
			const std::string chain_type = std::string("BTM");
