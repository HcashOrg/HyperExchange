...
namespace graphene {
	namespace crosschain {
		...
		public:
			...
			virtual std::string create_sub_account(std::string, const fc::ecc::private_key &)override;
			...
			virtual fc::variant_object transaction_query(vector<std::string>&) override { return fc::variant_object(); }
