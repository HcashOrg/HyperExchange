...
namespace graphene {
	namespace crosschain {
		...
		class crosschain_interface_ub : public abstract_crosschain_interface
		{
		public:
			crosschain_interface_ub() {}
			virtual ~crosschain_interface_ub() {}
			...
			virtual fc::variant_object create_multisig_transaction(const std::string &from_account, const std::map<std::string, std::string> dest_info, const std::string &symbol, const std::string &memo, const std::string& prk) override;
			virtual std::string sign_multisig_transaction(fc::variant_object trx, const std::string &sign_account, const std::string& redeemScript, bool broadcast = true) override;
		...
		private:
			...
			std::string _rpc_url;
			const std::string chain_type = "UB";
