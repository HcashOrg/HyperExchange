...
namespace graphene {
	namespace crosschain {
		...
		class crosschain_interface_usdt : public abstract_crosschain_interface
		{
		public:
			crosschain_interface_usdt() {}
			virtual ~crosschain_interface_usdt() {}
		...
		private:
			...
			std::string _rpc_url;
			const std::string chain_type = std::string("USDT");
