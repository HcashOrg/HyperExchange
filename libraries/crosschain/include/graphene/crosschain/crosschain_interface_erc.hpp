...
namespace graphene {
	namespace crosschain {
		...
		class crosschain_interface_erc : public abstract_crosschain_interface
		{
		public:
			crosschain_interface_erc() {}
			crosschain_interface_erc(std::string chain_id):chain_type(chain_id){}
			virtual ~crosschain_interface_erc() {}
